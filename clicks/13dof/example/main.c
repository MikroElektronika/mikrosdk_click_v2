 ...
 * BME680 Low power gas, pressure, temperature & humidity sensor, BMI088 6-axis Motion Tracking Sensor and
 * BMM150 Geomagnetic Sensor, also write log.
 * 
 * ## Application Task  
 * This is a example which demonstrates the use of 13DOF Click board.
 * Measured and display temperature in degrees Celsius [ �C ], humidity data [ % ], pressure [ mbar ] and gas resistance data from the BME680 sensor.
 * Measured and display Accel and Gyro data coordinates values for X-axis, Y-axis and Z-axis from the BMI088 sensor.
 * Measured and display Geomagnetic data coordinates values for X-axis, Y-axis and Z-axis from the BMM150 sensor.
