...
#ifndef MIKROBUS_POSITION_4GLTE2DATA
    #define MIKROBUS_POSITION_4GLTE2DATA MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    C4GLTE2DATA_MAP_MIKROBUS( c4glte2data_cfg, MIKROBUS_POSITION_4GLTE2DATA );
