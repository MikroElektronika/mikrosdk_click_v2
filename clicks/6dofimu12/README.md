...
> This application is presentation of functionality of click board.

**The demo application is composed of two sections :**

### Application Init 

> Initialization of log and communication modules and configuration of device.
...
void application_init ( void )
{
    ...
    tx_buf = C6DOFIMU12_PWR_CONF_ADV_PWR_SAVE_DISABLED | C6DOFIMU12_FIFO_READ_DISABLED | C6DOFIMU12_FAST_PWR_UP_DISABLED;
...
> Reading and presenting results on log
