...
<p align="center">
  <img src="http://download.mikroe.com/images/click_for_ide/9dof2_click.png" height=300px>
</p>
...
> Initalizes SPI and device drivers, performs safety check, applies default and writes an initial log.
...
> Demonstrates use of 9DOF 2 click board by reading angular rate, acceleration rate and displaying data via USART terminal.
