...
#ifndef MIKROBUS_POSITION_BAROMETER10
    #define MIKROBUS_POSITION_BAROMETER10 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    BAROMETER10_MAP_MIKROBUS( barometer10_cfg, MIKROBUS_POSITION_BAROMETER10 );
