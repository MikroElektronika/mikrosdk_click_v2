...
#ifndef MIKROBUS_POSITION_BRUSHLESS17
    #define MIKROBUS_POSITION_BRUSHLESS17 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    BRUSHLESS17_MAP_MIKROBUS( brushless17_cfg, MIKROBUS_POSITION_BRUSHLESS17 );
