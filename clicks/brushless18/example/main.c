...
#ifndef MIKROBUS_POSITION_BRUSHLESS18
    #define MIKROBUS_POSITION_BRUSHLESS18 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    BRUSHLESS18_MAP_MIKROBUS( brushless18_cfg, MIKROBUS_POSITION_BRUSHLESS18 );
