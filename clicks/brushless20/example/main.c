...
#ifndef MIKROBUS_POSITION_BRUSHLESS20
    #define MIKROBUS_POSITION_BRUSHLESS20 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    BRUSHLESS20_MAP_MIKROBUS( brushless20_cfg, MIKROBUS_POSITION_BRUSHLESS20 );
