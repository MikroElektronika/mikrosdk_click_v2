...
#ifndef MIKROBUS_POSITION_BRUSHLESS33
    #define MIKROBUS_POSITION_BRUSHLESS33 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    BRUSHLESS33_MAP_MIKROBUS( brushless33_cfg, MIKROBUS_POSITION_BRUSHLESS33 );
