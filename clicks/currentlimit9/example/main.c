...
#ifndef MIKROBUS_POSITION_CURRENTLIMIT9
    #define MIKROBUS_POSITION_CURRENTLIMIT9 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    CURRENTLIMIT9_MAP_MIKROBUS( currentlimit9_cfg, MIKROBUS_POSITION_CURRENTLIMIT9 );
