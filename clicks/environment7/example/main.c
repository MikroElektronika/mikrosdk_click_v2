...
#ifndef MIKROBUS_POSITION_ENVIRONMENT7
    #define MIKROBUS_POSITION_ENVIRONMENT7 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    ENVIRONMENT7_MAP_MIKROBUS( environment7_cfg, MIKROBUS_POSITION_ENVIRONMENT7 );
