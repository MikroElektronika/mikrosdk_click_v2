...
#ifndef MIKROBUS_POSITION_EZOCARRIEREC
    #define MIKROBUS_POSITION_EZOCARRIEREC MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    EZOCARRIEREC_MAP_MIKROBUS( ezocarrierec_cfg, MIKROBUS_POSITION_EZOCARRIEREC );
