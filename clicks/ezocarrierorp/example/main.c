...
#ifndef MIKROBUS_POSITION_EZOCARRIERORP
    #define MIKROBUS_POSITION_EZOCARRIERORP MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    EZOCARRIERORP_MAP_MIKROBUS( ezocarrierorp_cfg, MIKROBUS_POSITION_EZOCARRIERORP );
