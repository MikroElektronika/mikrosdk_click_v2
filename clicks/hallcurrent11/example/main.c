...
#ifndef MIKROBUS_POSITION_HALLCURRENT11
    #define MIKROBUS_POSITION_HALLCURRENT11 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    HALLCURRENT11_MAP_MIKROBUS( hallcurrent11_cfg, MIKROBUS_POSITION_HALLCURRENT11 );
