...
#ifndef MIKROBUS_POSITION_HALLCURRENT12
    #define MIKROBUS_POSITION_HALLCURRENT12 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    HALLCURRENT12_MAP_MIKROBUS( hallcurrent12_cfg, MIKROBUS_POSITION_HALLCURRENT12 );
