...
#ifndef MIKROBUS_POSITION_HALLCURRENT18
    #define MIKROBUS_POSITION_HALLCURRENT18 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    HALLCURRENT18_MAP_MIKROBUS( hallcurrent18_cfg, MIKROBUS_POSITION_HALLCURRENT18 );
