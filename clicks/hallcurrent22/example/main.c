...
#ifndef MIKROBUS_POSITION_HALLCURRENT22
    #define MIKROBUS_POSITION_HALLCURRENT22 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    HALLCURRENT22_MAP_MIKROBUS( hallcurrent22_cfg, MIKROBUS_POSITION_HALLCURRENT22 );
