/*!
 * @file main.c
 * @brief Hall Current 24 Click example
 *
 * # Description
 * This example demonstrates the use of Hall Current 24 Click board by reading and
 ...
 *
 * @note
 * The measurement range is approximately: +/- 5A.
 *
...
static hallcurrent24_t hallcurrent24;
static log_t logger;
