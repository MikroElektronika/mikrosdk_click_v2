/*!
 * @file main.c
 * @brief Hall Current 25 Click example
 *
 * # Description
 * This example demonstrates the use of Hall Current 25 Click board by reading and
...
#ifndef MIKROBUS_POSITION_HALLCURRENT25
    #define MIKROBUS_POSITION_HALLCURRENT25 MIKROBUS_1
#endif

// Load current [A] used for the data resolution calibration process.
#define HALLCURRENT25_CALIBRATING_CURRENT   3.0f

static hallcurrent25_t hallcurrent25;
static log_t logger;
