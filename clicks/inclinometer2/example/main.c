...
#ifndef MIKROBUS_POSITION_INCLINOMETER2
    #define MIKROBUS_POSITION_INCLINOMETER2 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    INCLINOMETER2_MAP_MIKROBUS( inclinometer2_cfg, MIKROBUS_POSITION_INCLINOMETER2 );
