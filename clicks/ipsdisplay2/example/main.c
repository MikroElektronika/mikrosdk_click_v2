...
#ifndef MIKROBUS_POSITION_IPSDISPLAY2
    #define MIKROBUS_POSITION_IPSDISPLAY2 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    IPSDISPLAY2_MAP_MIKROBUS( ipsdisplay2_cfg, MIKROBUS_POSITION_IPSDISPLAY2 );
