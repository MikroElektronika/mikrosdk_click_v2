...
#ifndef MIKROBUS_POSITION_IPSDISPLAY3
    #define MIKROBUS_POSITION_IPSDISPLAY3 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    IPSDISPLAY3_MAP_MIKROBUS( ipsdisplay3_cfg, MIKROBUS_POSITION_IPSDISPLAY3 );
