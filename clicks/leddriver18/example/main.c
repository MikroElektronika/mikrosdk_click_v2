...
#ifndef MIKROBUS_POSITION_LEDDRIVER18
    #define MIKROBUS_POSITION_LEDDRIVER18 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    LEDDRIVER18_MAP_MIKROBUS( leddriver18_cfg, MIKROBUS_POSITION_LEDDRIVER18 );
