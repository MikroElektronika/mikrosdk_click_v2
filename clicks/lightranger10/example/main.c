...
#ifndef MIKROBUS_POSITION_LIGHTRANGER10
    #define MIKROBUS_POSITION_LIGHTRANGER10 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    LIGHTRANGER10_MAP_MIKROBUS( lightranger10_cfg, MIKROBUS_POSITION_LIGHTRANGER10 );
