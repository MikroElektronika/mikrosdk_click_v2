...
#ifndef MIKROBUS_POSITION_LIGHTRANGER13
    #define MIKROBUS_POSITION_LIGHTRANGER13 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    LIGHTRANGER13_MAP_MIKROBUS( lightranger13_cfg, MIKROBUS_POSITION_LIGHTRANGER13 );
