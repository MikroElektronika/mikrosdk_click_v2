 ...
 * and calculate directions of the black line.
 *
 ...
 * demonstrates the direction of movement along the black line.
 * Blackline detection display 0 and the rest display 1.
 * 
...
void application_task ( void )
{
    ...
    log_printf( &logger, " %3d %3d %3d %3d %3d\r\n", data_track.u1, data_track.u2, data_track.u3, data_track.u4, data_track.u5 );
