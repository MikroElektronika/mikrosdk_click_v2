...
#ifndef MIKROBUS_POSITION_LTECAT13EX
    #define MIKROBUS_POSITION_LTECAT13EX MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    LTECAT13EX_MAP_MIKROBUS( ltecat13ex_cfg, MIKROBUS_POSITION_LTECAT13EX );
...
static err_t ltecat13ex_process ( void ) 
{
    ...
    int32_t rx_cnt = 0;
    int32_t rx_size = ltecat13ex_generic_read( &ltecat13ex, rx_buf, PROCESS_BUFFER_SIZE );
...
static void ltecat13ex_error_check( err_t error_flag )
{
    switch ( error_flag )
    {
        ...
        {
            ltecat13ex_send_cmd( &ltecat13ex, LTECAT13EX_CMD_QIGETERROR );
            ltecat13ex_log_app_buf( );
            break;
        }
...
static err_t ltecat13ex_cfg_for_network( void )
{
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_COPS, DEREGISTER_FROM_NETWORK );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
    
    // Set SIM APN
    ltecat13ex_set_sim_apn( &ltecat13ex, SIM_APN );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_CFUN, FULL_FUNCTIONALITY );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
    ...
    #define ENABLE_REG "2"
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_CREG, ENABLE_REG );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_COPS, AUTOMATIC_REGISTRATION );
...
static err_t ltecat13ex_check_connection( void )
{
    ...
    ltecat13ex_send_cmd_check( &ltecat13ex, LTECAT13EX_CMD_CREG );
    ltecat13ex_process( );
    if ( strstr( app_buf, CONNECTED_HOME ) || strstr( app_buf, CONNECTED_ROAMING ) )
    {
        ...
        ltecat13ex_send_cmd( &ltecat13ex, LTECAT13EX_CMD_CSQ );
        error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
        ltecat13ex_error_check( error_flag );
        return error_flag;
    }
...
static err_t ltecat13ex_cfg_for_example ( void )
{
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QIACT, ACTIVATE_CONTEXT );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );

    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QICSGP, ACTIVATE_CONTEXT );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );

#elif ( DEMO_EXAMPLE == EXAMPLE_SMS )
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_CMGF, SMS_MODE );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );

    #define DEFAULT_ALPHABET    "\"GSM\""
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_CSCS, DEFAULT_ALPHABET );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
#elif ( DEMO_EXAMPLE == EXAMPLE_CALL )
    if ( LTECAT13EX_OK != ltecat13ex_max9860_cfg( &ltecat13ex ) )
    {
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QGPS, TURN_ON_GPS );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
...
static err_t ltecat13ex_example ( void )
{
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QIOPEN, cmd_buf );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );

    // Send data to TCP socket
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QISEND, CONNECT_ID_TCP );
    strcpy( cmd_buf, MESSAGE_CONTENT );
    strcat( cmd_buf, txt_end );
    ltecat13ex_rsp_check( ">" );
    ltecat13ex_send_cmd( &ltecat13ex, cmd_buf );
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QIRD, cmd_buf );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );

    // Close TCP socket
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QICLOSE, CONNECT_ID_TCP );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    Delay_ms ( 1000 );
    Delay_ms ( 1000 );
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QISEND, CONNECT_ID_UDP );
    strcpy( cmd_buf, MESSAGE_CONTENT );
    strcat( cmd_buf, txt_end );
    ltecat13ex_rsp_check( ">" );
    ltecat13ex_send_cmd( &ltecat13ex, cmd_buf );
    ...
    // Close UDP socket
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QICLOSE, CONNECT_ID_UDP );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ...
    ltecat13ex_send_cmd_check( &ltecat13ex, LTECAT13EX_CMD_CMGF );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    if ( strstr( app_buf, CMGF_PDU ) )
    {
        ...
        ltecat13ex_send_sms_pdu( &ltecat13ex, SIM_SMSC, PHONE_NUMBER, MESSAGE_CONTENT );
        error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
        func_error |= error_flag;
    }
    else if ( strstr( app_buf, CMGF_TXT ) )
    {
        ...
        ltecat13ex_send_sms_text ( &ltecat13ex, PHONE_NUMBER, MESSAGE_CONTENT );
        error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
        func_error |= error_flag;
    }
    ltecat13ex_error_check( error_flag );
    ...
    ltecat13ex_send_cmd( &ltecat13ex, LTECAT13EX_CMD_CLCC );    
    ...
    ltecat13ex_send_cmd( &ltecat13ex, LTECAT13EX_CMD_CHUP );
    ltecat13ex_clear_app_buf( );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
    ltecat13ex_error_check( error_flag );
    ...
    ltecat13ex_send_cmd_with_params( &ltecat13ex, LTECAT13EX_CMD_QGPSGNMEA, GPS_NEMA_GGA );
    error_flag = ltecat13ex_rsp_check( LTECAT13EX_RSP_OK );
    func_error |= error_flag;
