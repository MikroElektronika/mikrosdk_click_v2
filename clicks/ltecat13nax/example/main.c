...
#ifndef MIKROBUS_POSITION_LTECAT13NAX
    #define MIKROBUS_POSITION_LTECAT13NAX MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    LTECAT13NAX_MAP_MIKROBUS( ltecat13nax_cfg, MIKROBUS_POSITION_LTECAT13NAX );
