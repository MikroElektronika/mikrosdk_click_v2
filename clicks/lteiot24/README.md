...
> [LTE IoT 24 Click](https://www.mikroe.com/?pid_product=MIKROE-6933) demo application is developed using
the [NECTO Studio](https://www.mikroe.com/necto), ensuring compatibility with [mikroSDK](https://www.mikroe.com/mikrosdk)'s
open-source libraries and tools. Designed for plug-and-play implementation and testing, the demo is fully compatible with
all development, starter, and mikromedia boards featuring a [mikroBUS&trade;](https://www.mikroe.com/mikrobus) socket.

<p align="center">
  <img src="https://www.mikroe.com/?pid_product=MIKROE-6933&image=1" height=300px>
</p>
...
- `lteiot24_cfg_setup` This function initializes Click configuration structure to initial values.
```c
void lteiot24_cfg_setup ( lteiot24_cfg_t *cfg );
```

- `lteiot24_init` This function initializes all necessary pins and peripherals used for this Click board.
```c
err_t lteiot24_init ( lteiot24_t *ctx, lteiot24_cfg_t *cfg );
```

- `lteiot24_set_sim_apn` This function sets APN for sim card.
```c
void lteiot24_set_sim_apn ( lteiot24_t *ctx, uint8_t *sim_apn );
```

- `lteiot24_send_sms_text` This function sends text message to a phone number.
```c
void lteiot24_send_sms_text ( lteiot24_t *ctx, uint8_t *phone_number, uint8_t *sms_text );
```

- `lteiot24_cmd_run` This function sends a specified command to the Click module.
```c
