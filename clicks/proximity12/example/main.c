...
#ifndef MIKROBUS_POSITION_PROXIMITY12
    #define MIKROBUS_POSITION_PROXIMITY12 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    PROXIMITY12_MAP_MIKROBUS( proximity12_cfg, MIKROBUS_POSITION_PROXIMITY12 );
