...
#ifndef MIKROBUS_POSITION_PROXIMITY18
    #define MIKROBUS_POSITION_PROXIMITY18 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    PROXIMITY18_MAP_MIKROBUS( proximity18_cfg, MIKROBUS_POSITION_PROXIMITY18 );
