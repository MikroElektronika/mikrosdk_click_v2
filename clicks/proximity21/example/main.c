...
#ifndef MIKROBUS_POSITION_PROXIMITY21
    #define MIKROBUS_POSITION_PROXIMITY21 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    PROXIMITY21_MAP_MIKROBUS( proximity21_cfg, MIKROBUS_POSITION_PROXIMITY21 );
