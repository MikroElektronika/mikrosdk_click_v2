...
#ifndef MIKROBUS_POSITION_SOLIDSWITCH2
    #define MIKROBUS_POSITION_SOLIDSWITCH2 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    SOLIDSWITCH2_MAP_MIKROBUS( solidswitch2_cfg, MIKROBUS_POSITION_SOLIDSWITCH2 );
