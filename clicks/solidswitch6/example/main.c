...
#ifndef MIKROBUS_POSITION_SOLIDSWITCH6
    #define MIKROBUS_POSITION_SOLIDSWITCH6 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    SOLIDSWITCH6_MAP_MIKROBUS( solidswitch6_cfg, MIKROBUS_POSITION_SOLIDSWITCH6 );
