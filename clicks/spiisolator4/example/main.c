...
#ifndef MIKROBUS_POSITION_SPIISOLATOR4
    #define MIKROBUS_POSITION_SPIISOLATOR4 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    SPIISOLATOR4_MAP_MIKROBUS( spiisolator4_cfg, MIKROBUS_POSITION_SPIISOLATOR4 );
