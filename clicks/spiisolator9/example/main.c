...
#ifndef MIKROBUS_POSITION_SPIISOLATOR9
    #define MIKROBUS_POSITION_SPIISOLATOR9 MIKROBUS_1
#endif
...
void application_init ( void )
{
    ...
    SPIISOLATOR9_MAP_MIKROBUS( spiisolator9_cfg, MIKROBUS_POSITION_SPIISOLATOR9 );
