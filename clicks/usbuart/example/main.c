 ...
 * 
 * ## Additional Function
 * - usbuart_process ( ) - The general process of collecting presponce 
 *                                   that sends a module.
 * 
 * \author MikroE Team
 *
...
static void usbuart_process ( void )
{
    uint16_t rsp_size;
    ...
    while( process_cnt != 0 )
    {
        rsp_size = usbuart_generic_read( &usbuart, &uart_rx_buffer, PROCESS_RX_BUFFER_SIZE );
