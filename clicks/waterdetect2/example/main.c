...
#ifndef MIKROBUS_POSITION_WATERDETECT2
    #define MIKROBUS_POSITION_WATERDETECT2 MIKROBUS_1
#endif
...
void application_init ( void ) 
{
    ...
    WATERDETECT2_MAP_MIKROBUS( waterdetect2_cfg, MIKROBUS_POSITION_WATERDETECT2 );
